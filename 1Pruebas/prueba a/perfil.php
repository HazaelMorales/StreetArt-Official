...
<div class="container" style="margin-top: 20px; margin-bottom: 20px;">
    ...
    <div class="row nav">    
        ...
        <div class="col-md-18 col-xs-12" style="margin:0px;padding:0px;">
            ...
            <div class="col-md-2 col-xs-2 well"><i class="fa fa-camera fa-lg"> biografia</i> </div>
            <div class="col-md-2 col-xs-2 well"><i class="fa fa-camera fa-lg"> fotos</i> </div>
            <div class="col-md-2 col-xs-2 well"><i class="fa fa-camera fa-lg"> videos</i> </div>
            <div class="col-md-2 col-xs-2 well"><i class="fa fa-camera fa-lg"> seguidores</i> </div>
            <div class="col-md-2 col-xs-2 well"><i class="fa fa-camera fa-lg "> seguidos</i> </div>
             <div class="col-md-2 col-xs-2 well"><i class="fa fa-camera fa-lg "> configuración</i> </div>
        </div>
    </div>
</div>
